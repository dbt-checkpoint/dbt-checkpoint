...
* [What is pre-commit-dbt](README.md)
...
* [Model checks](list-of-checks/model-checks/README.md)
  ...
  * [check-model-has-all-columns](list-of-checks/model-checks/check-model-has-all-columns.md)
  * [check-model-columns-have-desc](list-of-checks/model-checks/check-model-columns-have-desc.md)
  * [check-column-name-contract](list-of-checks/model-checks/check-column-name-contract.md)
  * [check-column-desc-are-same](list-of-checks/model-checks/check-column-desc-are-same.md)
* [Source checks](list-of-checks/source-checks.md)
