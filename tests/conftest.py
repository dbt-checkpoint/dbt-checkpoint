...
MANIFEST = {
    ...
    "nodes": {
        ...
        "model.in_schema_with_and_manifest_without_columns_meta": {
            ...
            "patch_path": "project://bb/in_schema_with_and_manifest_without_columns_meta.yml",
        ...
        "_columns_meta_extra_column_in_manifest": {
            ...
            "patch_path": "project://bb/in_schema_with_and_manifest_without_columns_meta_extra_column_in_manifest.yml",
